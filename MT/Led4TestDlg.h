...
class CLed4TestDlg : public CDialogEx
{
	DECLARE_DYNAMIC(CLed4TestDlg)

public:
	CLed4TestDlg(LPVOID p,  TESTERTYPE type, CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CLed4TestDlg();

	// 对话框数据
	enum { IDD = IDD_DLG_LED4_TEST };
